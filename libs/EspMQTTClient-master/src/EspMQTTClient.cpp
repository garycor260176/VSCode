...
unsigned int EspMQTTClient::get_count_failed_connect_attempt(){
  return _failedMQTTConnectionAttemptCount;
}

void EspMQTTClient::reset_count_failed_connect_attempt(){
   _failedMQTTConnectionAttemptCount = 0;
}
