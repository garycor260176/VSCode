...
const int kMatrixWidth =    10;                     // Matrix width --> number of columns in your led matrix
const int kMatrixHeight =   16 ;                    // Matrix height --> number of leds per column
...
// Arduino pin number where the button is connected.                                              //**
                                                                                                  //**
#define MODE_BUTTON_PIN     GPIO_NUM_25                                                           //**
